...
<template>
	...
	>
		...
		<view class="sk-role__body">
			<text class="sk-role__name">{{ role.name }}</text>
			<text class="sk-role__public">{{ role.public }}</text>
			<view class="sk-role__goal">
				<text class="sk-role__goal-label">目标</text>
				<text class="sk-role__goal-text">{{ role.goal }}</text>
			</view>
		</view>
		<view v-if="selected" class="sk-role__check">✓</view>
	</view>
</template>
